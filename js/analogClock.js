...
function startAnalogClock() { //creating function startClock()
    const canvas = document.getElementById("analogClock"); //getting reference to canvas element
    ...
    analogInt = setInterval(drawClock, 1000); //calling setInterval to invoke drawClock every 1 second
